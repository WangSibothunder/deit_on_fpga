...
module ppu_tb;
    ...
    initial begin
        ...
        if (!$test$plusargs("NO_FILE_CHECK")) begin
             $readmemh("src/data/test_data/ppu_inputs.mem", mem_inputs);
             $readmemh("src/data/test_data/ppu_golden.mem", mem_golden);
             $readmemh("src/data/test_data/ppu_config.mem", mem_config);
        end
