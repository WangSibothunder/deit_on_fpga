// -----------------------------------------------------------------------------
// 文件名: src/tb/deit_core_verify_tb.v
...
module deit_core_verify_tb;
    ...
    initial begin
        ...
        // 1. Load Data
        $readmemh("src/data/test_data_core/core_input.mem", mem_input_data);
        $readmemh("src/data/test_data_core/core_weight.mem", mem_weight_data);
        $readmemh("src/data/test_data_core/core_golden.mem", mem_golden_data);
