// -----------------------------------------------------------------------------
// ļ: src/rtl/deit_core_verify_tb_v2.v
...
module deit_core_verify_tb_v2;
    ...
    initial begin
        // ʹ·ڸĿ¼нű
        $readmemh("src/data/test_data_core/input_k0.mem", mem_in_k0);
        $readmemh("src/data/test_data_core/input_k1.mem", mem_in_k1);
        
        $readmemh("src/data/test_data_core/weight_k0_n0.mem", mem_w_k0_n0);
        $readmemh("src/data/test_data_core/weight_k1_n0.mem", mem_w_k1_n0);
        $readmemh("src/data/test_data_core/weight_k0_n1.mem", mem_w_k0_n1);
        $readmemh("src/data/test_data_core/weight_k1_n1.mem", mem_w_k1_n1);
        
        $readmemh("src/data/test_data_core/golden_n0.mem", mem_gold_n0);
        $readmemh("src/data/test_data_core/golden_n1.mem", mem_gold_n1);
    end
