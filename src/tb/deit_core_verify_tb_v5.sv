...
module deit_core_verify_tb;
    ...
    initial begin
        ...
        // Load Data
        $readmemh("src/data/test_data_core/w_k0.mem", w_k0);
        $readmemh("src/data/test_data_core/w_k1.mem", w_k1);
        $readmemh("src/data/test_data_core/a_m0_k0.mem", a_m0_k0);
        $readmemh("src/data/test_data_core/a_m0_k1.mem", a_m0_k1);
        $readmemh("src/data/test_data_core/a_m1_k0.mem", a_m1_k0);
        $readmemh("src/data/test_data_core/a_m1_k1.mem", a_m1_k1);
        $readmemh("src/data/test_data_core/golden.mem", golden_mem);
