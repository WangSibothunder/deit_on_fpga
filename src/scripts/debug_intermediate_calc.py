...
# 文件路径 (请根据你的实际文件名修改)
FILE_IN_K0 = "src/data/test_data_top/axis_input_k0.mem"
FILE_IN_K1 = "src/data/test_data_top/axis_input_k1.mem"

FILE_W_K0  = "src/data/test_data_top/axis_weight_k0_n0.mem"
FILE_W_K1  = "src/data/test_data_top/axis_weight_k1_n0.mem" # 注意：这里假设是计算 N0 Tile
