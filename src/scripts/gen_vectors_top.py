...
# 1. System Config
# ==============================================================================
DEFAULT_M = 197   # DeiT-tiny sequence length (197 tokens)
DEFAULT_K = 192   # DeiT-tiny embed dim
DEFAULT_N = 384   # KV projection (2 * embed dim)
...
OUT_DIR = "src/data/test_data_top"
...
def generate_system_vectors(m_dim, k_dim, n_dim, seed=None):
    print("=== Generating Top-Level Vectors ===")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate top-level test vectors")
    parser.add_argument("--m", type=int, default=DEFAULT_M, help="M dimension")
    parser.add_argument("--k", type=int, default=DEFAULT_K, help="K dimension")
    parser.add_argument("--n", type=int, default=DEFAULT_N, help="N dimension")
    parser.add_argument("--seed", type=int, default=None, help="Random seed")
    args = parser.parse_args()
    generate_system_vectors(args.m, args.k, args.n, seed=args.seed)
