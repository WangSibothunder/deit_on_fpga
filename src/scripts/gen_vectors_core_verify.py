...
def generate_test_data():
    os.makedirs('src/data/test_data_core', exist_ok=True)
    ...
    # Save Files
    write_weights('src/data/test_data_core/w_k0.mem', w_k0)
    write_weights('src/data/test_data_core/w_k1.mem', w_k1)
    
    write_inputs ('src/data/test_data_core/a_m0_k0.mem', a_m0_k0)
    write_inputs ('src/data/test_data_core/a_m0_k1.mem', a_m0_k1)
    write_inputs ('src/data/test_data_core/a_m1_k0.mem', a_m1_k0)
    write_inputs ('src/data/test_data_core/a_m1_k1.mem', a_m1_k1)
    
    write_golden ('src/data/test_data_core/golden.mem', golden_full)
    
    print(f"Generated 7 files in src/data/test_data_core/")
